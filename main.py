...
if __name__ == "__main__":
    ...
    # id-2
    MEMBER_ID = "GK00506080"
    SESSION_ID, TOTAL_AMOUNT = login("OOcLeIduo1Hi1cdXB04zQxbXQAk5DilNCY9Tu/5t18qfCjoxZtPyL4SZgdWghdDUKXfPceWywABdYkqwxdQQWZCyRFtzIDBvxjX/aLByF+U=")
